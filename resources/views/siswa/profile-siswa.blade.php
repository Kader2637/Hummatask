...
@section('style')
  ...
  <style>
    ...
    .hover-label .image-container .img-img {
      position: absolute;
      z-index: 2;
      width: 100%;
      height: 100%;
    ...
    .hover-label .image-container .img-img img {
      width: 120px;
      height: 120px;
      border-color: #fff;
      border: 5px solid;
    ...
    .hover-label .image-container .overlay {
      position: absolute;
      z-index: 4;
      width: 100%;
      height: 100%;
    ...
    .hover-label .image-container .overlay i {
      font-size: 30px;
    }

    .hover-label .image-container .overlay:hover {
      opacity: 0.7;
    }
              ...
              <div class="row">
                @forelse ($tims as $item)
                  ...
                  <div class="col-md-6 col-lg-4">
                    <div class="card text-center mb-3 tim-item" data-status-tim="{{ $item->status_tim }}">
                      <div class="card-body">
                        <img src="{{ asset('storage/' . $item->logo) }}" alt="logo tim" class="rounded-circle mb-3"
                        ...
                        <a data-bs-toggle="" data-bs-target="#modalDetailProjek"
                          ...
                          data-logo="{{ asset('storage/' . $item->logo) }}" data-namatim="{{ $item->nama }}"
                          ...
                          data-deskripsi="{{ $item->deskripsi }}" data-dayleft="{{ $dayLeft }}"
                          data-total-deadline="{{ $totalDeadline }}" data-progress="{{ $progressPercentage }}"
                          data-repo="{{ $item->repository }}"><span class="text-white">Detail</span>
                        </a>
                      </div>
                    </div>
                  </div>
                                          ...
                                          <div class="col-lg-12">
                                            <div class="d-flex flex-row gap-3">
                                              ...
                                              <div class="d-flex flex-column justify-content-center align-items-center">
                                                <span class="d-block text-black fs-5" id="nama-tim">nama
                                                  tim</span>
                                              </div>
                                            </div>
                                            <div class="mt-4">
                                              <div class="mb-3">
                                                Status: <span class="badge bg-label-warning" id="status"></span>
                                              </div>
                                              <div>
                                                Tema: <span class="badge bg-label-warning" id="tema"></span>
                                              </div>
                                            </div>
                                          </div>
                                        </div>
