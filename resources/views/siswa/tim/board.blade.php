                    ...
                    @section('content')
                        ...
                        <div style="height: 80vh;" class="container-fluid mt-2 overflow-x-scroll">
                            <div class="mt-3 mb-0 row hide-sroll overflow-x-scroll" style="height: 83vh;">
                                <div style="" class="col-lg-3 col-md-6 col-12 py-2">
                                    <div style="max-height: 80vh; overflow:auto; background-color: #edeaea"
                                        class="p-2  rounded">
                    ...
                    @section('script')
                                        ...
                                        dataTugas.forEach((data, index) => {
                                            ...
                                            <div>
                                                ...
                                                <div class="d-flex flex-wrap gap-1">
                                                    ${labels}
                                                    ${
                                                        tugas.status_catatan == "revisi_mentor"
                                                        ?
                                                        `<span style="
                        ...
                        `
                                            ...
                                            } else if (tugas.status_tugas === "revisi_mentor") {
                                                $("#revisi_mentor").append(element)
                                            } else {
                            ...
                            function deleteTugas(codetugas) {
                                ...
                                swalWithBootstrapButtons.fire({
                                    ...
                                    text: "Tugas tidak dapat dikembalikan lagi!",
                                    icon: "warning",
                                    showCancelButton: true,
                                    confirmButtonText: "Hapus",
                                    cancelButtonText: "Batal",
