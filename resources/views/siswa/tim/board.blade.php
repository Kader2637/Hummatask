                                ...
                                <form id="formEditLabel" method="post">
                                  ...
                                  <div class="row">
                                    <div class="col mb-3">
                                      ...
                                      <input type="text" id="editText" class="form-control" value="Label"
                                  ...
                                  <ul class="nav nav-tabs nav-fill" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                      <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false" tabindex="-1">Daftar</button>
                                    </li>
                                  </ul>
                                    ...
                                    <div class="tab-pane fade active show" id="navs-justified-home" role="tabpanel">
                                      ...
                                      <form id="formTambahLabel" method="post">
                                        ...
                                        <div class="row">
                                          <div class="col mb-3">
                                            <label for="Text" class="form-label">Text</label>
                                            <input type="text" id="Text" class="form-control" value="Label"
                                              placeholder="Enter text">
                                          </div>
                                        </div>
                                        <div class="row g-2">
                                  ...
                                  <div class="d-flex justify-content-between align-items-center w-100 gap-2">
                                    <div class="select2-primary w-100" data-select2-id="92">
                                      ...
                                      <select name="labels[]" id="labels"
                                        ...
                                        data-select2-id="labels" tabindex="-1" aria-hidden="true">

                                      </select>
                                    </div>
                                    <button data-bs-toggle="modal" data-bs-target="#tambahLabel" type="button"
