                                                ...
                                                <label class="form-check-label custom-option-content"
                                                    ...
                                                    <span class="custom-option-header">
                                                        <span class="h6 mb-0">Catatan Revisi <span
                                                                class="text-warning">(Tidak bisa di edit atau
                                                                hapus)</span></span>
                                                    </span>
                                                </label>
                                            </div>
                                                    ...
                                                    @if ($item->type_note === 'private')
                                                        <td class="d-flex flex-wrap flex-row gap-1">
                                                            ...
                                                            <a class="d-block cursor-pointer btn-edit"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#edit-catatan{{ $item->id }}"
                                                                data-content="{{ $item->content }}"
                                                                data-url="{{ $item->code }}"
                        ...
                        <div class="modal fade" id="edit-catatan{{ $data->id }}" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-md modal-edit-user">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('catatan.update', $data->id) }}" id="edit-form"
                                        ...
                                        <div class="modal-body">
                                            <div
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="titleEdit" value="{{ $data->title }}"
                                                ...
                                                <div class="form-add-edit">
                                                    @foreach ($data->catatanDetail as $i => $item)
                                                        ...
                                                        <div class="form-catatan-repeater row mb-3">
                                                            <div
                                                                class="col-md-{{ $hideDeleteButton ? '12' : '11' }} col-10">
                                                                <label for="catatan" class="mb-2 form-label">Catatan
                                                                    {{ ++$i }}</label>
                                                                <input name="catatan_text[]" id="catatan-input-edit"
                                                                    type="text" value="{{ $item->catatan_text }}"
                                                                    class="form-control">
                                                                <input type="hidden" name="id[]"
                                                                    value="{{ $item->id }}">
                                                            </div>
                                                            <div
                                                                class="col-md-1 col-1 d-flex justify-content-center align-items-end">
                                                                <div>
                                                ...
                                                if (result.isConfirmed) {
                                                    $.ajax({
                                                        ...
                                                        success: function(response) {
                                                            var remainingForms = $formCatatanRepeater.siblings(
                                                                    '.form-catatan-repeater')
                                                                .length;
                                    ...
                                    <div class="modal-body">
                                        <div class="container">
                                            <div class="mb-3">
                                                <label for="titleEdit" class="form-label">Judul</label>
                                                <input type="text" id="titleEdit" value="{{ $data->title }}"
                                                    name="titleEdit" class="form-control mb-3" readonly>
                                            </div>
                                            @foreach ($data->catatanDetail as $i => $item)
                                                <div class="form-catatan-repeater mb-3">
                                                    <label>Catatan {{ ++$i }}</label>
                                                    <input name="catatan_text[]" value="{{ $item->catatan_text }}"
