  ...
  <div class="modal fade" id="ajukanModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        <form id="editUserForm" class="" action="{{ route('tim.ajukanProject', $tim->code) }}" method="POST">
          @csrf
          ...
          <div class="modal-body">
            <div class="col-12 col-md-12 d-flex flex-row gap-3 align-items-center">
              <div class="col-12 col-md-12 d-flex flex-wrap flex-col align-items-center">
                ...
                <input type="text" id="modalEditUserLastName" name="repository"
                  class="form-control @error('repository') is-invalid @enderror" placeholder="https://.." />
                @error('repository')
            ...
            <div class="col-12 justify-content-center">
              ...
              <input id="TagifyBasic" class="form-control @error('temaInput') is-invalid @enderror" name="temaInput"
                placeholder="Masukkan 10 tema pilihan anda" />
              @error('temaInput')
                <div class="text-danger">{{ $message }}</div>
              @enderror
            </div>
            ...
            <div class="row">
              <div class="col mb-3 text-center">
                <label class="form-label text-white" for="image-input">
                  <img id="preview-image" src="{{ asset('storage/' . $tim->logo) }}" alt="example placeholder"
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="d-flex flex-column justify-content-center align-items-center gap-3">
                          <div>
                            <img src="{{ asset('storage/' . $tim->logo) }}" alt='logo tim' class="rounded-circle"
                        ...
                        <div class="mt-4">
                          ...
                          <div class="mb-3">Kategori : <span class="badge bg-label-warning">
                          ...
                          @if (@isset($project) && $project->deadline)
                            <div>Tema : <span class="badge bg-label-warning" data-bs-toggle="tooltip"
                      ...
                      <div class="progres-bar">
                            ...
                            <div class="d-flex flex-grow-1 align-items-center my-1">
                              <div class="progress w-100 me-3" style="height:8px;">
                                <div class="progress-bar bg-primary" role="progressbar"
                                  ...
                                  aria-valuenow="{{ round($progressPercentage) }}" aria-valuemin="0"
                                  aria-valuemax="100">
                                </div>
                              </div>
                        ...
                        @elseif (@isset($project) && $project->deskripsi == null)
                          <div class="alert alert-warning d-flex align-items-center cursor-pointer" role="alert"
                            data-bs-toggle="modal" data-bs-target="#editProject" style="font-size: 12px">
                            <span class="alert-icon text-warning me-2">
                              <i class="ti ti-bell ti-xs"></i>
                            </span>
                        ...
                        @else
                          @if ($tim->kadaluwarsa == '0')
                            <div class="alert alert-warning d-flex align-items-center cursor-pointer" role="alert"
                              data-bs-toggle="modal" data-bs-target="#ajukanModal" style="font-size: 12px">
                              <span class="alert-icon text-warning me-2">
                                <i class="ti ti-bell ti-xs"></i>
                              </span>
                          ...
                          @elseif ($tim->kadaluwarsa == '1')
                            <div class="alert alert-danger d-flex align-items-center cursor-pointer" role="alert"
                ...
                <div class="col-lg-4 my-1 px-1" style="box-shadow: none">
                  <div class="card">
                    <div class="card-body d-flex gap-3 align-items-center">
                      <div>
                        <img width="30px" height="30px" class="rounded-circle" style="object-fit: cover"
                          src="{{ $item->user->avatar ? asset('storage/' . $item->user->avatar) : asset('assets/img/avatars/1.png') }}"
                          alt="foto user">
                      </div>
                      <div>
                        <h5 class="mb-0" style="font-size: 15px" data-bs-toggle="tooltip" data-bs-placement="top"
                          title="{{ $item->user->username }}">
                          {{ Str::limit($item->user->username, 18) }}</h5>
                        <div>
                          @if ($item->status == 'active')
                            @if ($item->jabatan->nama_jabatan == 'Ketua Kelompok')
                              <span class="badge bg-label-primary">Ketua Kelompok</span>
                            @else
