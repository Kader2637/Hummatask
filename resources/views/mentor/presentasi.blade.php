                            ...
                            {{-- <div class="row"> --}}
                                ...
                                <div class="nav-item col-lg-3 col-md-6" role="presentation">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false" tabindex="-1"><i class="ti ti-presentation-analytics me-2"></i>Presentasi</button>
                                </div>
                                <div class="nav-item col-lg-3 col-md-6" role="presentation">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                        data-bs-target="#navs-pills-top-baru" aria-controls="navs-pills-top-profile"
                                        aria-selected="false" tabindex="-1"><i class="ti ti-adjustments-horizontal me-2"></i>Belum Presentasi</button>
                                </div>
                                <div class="nav-item col-lg-3 col-md-6" role="presentation">
                                    <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                        data-bs-target="#navs-pills-top-start" aria-controls="navs-pills-top-profile"
                                        aria-selected="false" tabindex="-1"><i class="ti ti-clock-exclamation me-2"></i>Telat</button>
                                </div>
                            {{-- </div> --}}
                            </div>
                            </div>
                            ...
                            <div class="table-responsive text-nowrap">
                                ...
                                <table class="table">
                                    <div class="">
                                        ...
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td><img src="{{ asset('assets/img/avatars/10.png') }}"
                                            ...
                                            <td><button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#Reject">Tolak</button>
            ...
            <div class="tab-pane fade" id="navs-pills-top-profile" role="tabpanel">
                    ...
                    <table class="table">
                        <div class="">
                            ...
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td><img src="{{ asset('assets/img/avatars/10.png') }}" alt="" style="border-radius: 50%; width:40px;"> Hidan</td>
                                <td>21-03-2023</td>
                                <td>Senin</td>
                                <td>Solo Project</td>
                                <td>Sekolah</td>
                                <td><button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#Reset">Atur ulang</button>
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#Finish">Selesai</button></td>
                            </tr>
                        </div>
                    </table>
                </div>
