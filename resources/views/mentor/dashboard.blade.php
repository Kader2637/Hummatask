                                ...
                                <form id="form-senin active" action="{{ route('presentasi-divisi.store') }}" method="POST">
                                    ...
                                    <div id="form-repeater">
                                        <div class="d-flex justify-content-end">
                                          <button class="btn btn-primary">Setting Limit</button>
                                        </div>
                                        ...
                                        @if ($rabu)
                                            @foreach ($rabu->limitPresentasiDivisis as $key => $data)
                                                <div class="row form-column align-items-center">
                                                    ...
                                                    <div class="mb-3 col-lg-6 col-xl-3 col-12 mb-0">
                                                        <input type="time" name="akhir[]" value="{{ $data->akhir }}"
                                                            class="form-control" />
                                                    </div>
                                                    <div class="mb-3 col-lg-12 col-xl-2 col-12 mb-0">
                                                        <button class="btn btn-label-danger delete-data-column-rabu"
                                                            data-id="{{ $data->id }}">
                                            ...
                                            @endforeach
                                        @else
                                            <p id="belum-ada-jadwal-rabu" class="text-dark fs-6 mt-3 text-center"
                                        ...
                                        @if ($kamis)
                                            @foreach ($kamis->limitPresentasiDivisis as $key => $data)
                                                <div class="row form-column align-items-center">
                                                    ...
                                                    <div class="mb-3 col-lg-12 col-xl-2 col-12 mb-0">
                                                        <button class="btn btn-label-danger delete-data-column-kamis"
                                                            data-id="{{ $data->id }}">
                                                            <i class="ti ti-x ti-xs me-1"></i>
                                                            <span class="align-middle">Delete</span>
                                                        </button>
                                            ...
                                            @endforeach
                                        @else
                                            <p id="belum-ada-jadwal-kamis" class="text-dark fs-6 mt-3 text-center"
                                                style="font-weight: 550;">
                                                Jadwal Presentasi Belum Ada
                                            </p>
                                        @endif
                                        ...
                                        @if ($jumat)
                                            @foreach ($jumat->limitPresentasiDivisis as $key => $data)
                                                <div class="row form-column align-items-center">
                                                    ...
                                                    <div class="mb-3 col-lg-12 col-xl-2 col-12 mb-0">
                                                        <button class="btn btn-label-danger delete-data-column-jumat"
                                                            data-id="{{ $data->id }}">
                                                            <i class="ti ti-x ti-xs me-1"></i>
                                                            <span class="align-middle">Delete</span>
                                                        </button>
                                            ...
                                            @endforeach
                                        @else
                                            <p id="belum-ada-jadwal-jumat" class="text-dark fs-6 mt-3 text-center"
                                                style="font-weight: 550;">
                                                Jadwal Presentasi Belum Ada
                                            </p>
                                        @endif
            ...
            <div class="col-12 col-xl-4">
                <div class="card">
                    <div class="d-flex justify-content-between mx-3 mb-1 mt-4">
                        ...
                        <a href="{{ route('presentasi.mentor') }}"
