                    ...
                    <div class="card-body m-0">
                        ...
                        <div class="tab-content mt-3">
                            ...
                            <div class="tab-pane {{ \Carbon\Carbon::now()->format('l') === 'Monday' || \Carbon\Carbon::now()->format('l') === 'Saturday' || \Carbon\Carbon::now()->format('l') === 'Sunday' ? 'show active' : '' }}"
                                ...
                                <form id="form-senin" class="form-senin"
                                    action="{{ route('presentasi-divisi-create-jam.store') }}" method="POST">
                                    @csrf
                            ...
                            <div class="tab-pane {{ \Carbon\Carbon::now()->format('l') === 'Tuesday' ? 'show active' : '' }}"
                                ...
                                <form id="form-selasa" class="form-selasa"
                                    action="{{ route('presentasi-divisi-create-jam.store') }}" method="POST">
                                    @csrf
                            ...
                            <div class="tab-pane {{ \Carbon\Carbon::now()->format('l') === 'Wednesday' ? 'show active' : '' }}"
                                ...
                                <form id="form-rabu" class="form-rabu"
                                    action="{{ route('presentasi-divisi-create-jam.store') }}" method="POST">
                                    @csrf
                            ...
                            <div class="tab-pane {{ \Carbon\Carbon::now()->format('l') === 'Thursday' ? 'show active' : '' }} "
                                ...
                                <form id="form-kamis" class="form-kamis"
                                    action="{{ route('presentasi-divisi-create-jam.store') }}" method="POST">
                                    @csrf
                            ...
                            <div class="tab-pane {{ \Carbon\Carbon::now()->format('l') === 'Friday' ? 'show active' : '' }}"
                                ...
                                <form id="form-jumat" class="form-jumat"
                                    action="{{ route('presentasi-divisi-create-jam.store') }}" method="POST">
                                    @csrf
                            ...
                            @foreach ($divisis as $index => $divisi)
                                <li class="nav-item">
                                    <a class="nav-link {{ $index == 0 ? 'active' : '' }}" data-bs-toggle="tab"
                                        href="#{{ $divisi->name }}" role="tab">{{ $divisi->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                        <div class="tab-content mt-3">
                            @foreach ($divisis as $index => $divisi)
                                <div class="tab-pane {{ $index == 0 ? 'active' : '' }}" id="{{ $divisi->name }}"
                                    role="tabpanel">
                                    <div class="card">
