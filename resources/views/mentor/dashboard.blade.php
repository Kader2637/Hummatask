    ...
    <div class="table-responsive text-nowrap">
      <table class="table">
        ...
        <tbody class="table-border-bottom-0">
            <tr>
                <td>1</td>
                <td><img src="{{ asset('assets/img/avatars/10.png') }}" alt="" style="width: 40px; border-radius:50%;"> Andi</td>
                <td>21-03-2023</td>
                <td>Senin</td>
                <td>Solo Project</td>
            ...
            <tr>
                <td>2</td>
                <td><img src="{{ asset('assets/img/avatars/12.png') }}" alt="" style="width: 40px; border-radius:50%;"> Rohim</td>
                <td>21-03-2023</td>
                <td>Selasa</td>
                <td>Solo Project</td>
                <td><span class="badge bg-label-success me-1">Tertunda</span></td>
            ...
            <tr>
                <td>3</td>
                <td><img src="{{ asset('assets/img/avatars/2.png') }}" alt="" style="width: 40px; border-radius:50%;"> Dina</td>
                <td>21-03-2023</td>
                <td>Selasa</td>
                <td>Solo Project</td>
                <td><span class="badge bg-label-success me-1">Tertunda</span></td>
            ...
            <tr>
                <td>4</td>
                <td><img src="{{ asset('assets/img/avatars/4.png') }}" alt="" style="width: 40px; border-radius:50%;"> Indah</td>
                <td>21-03-2023</td>
                <td>Selasa</td>
                <td>Solo Project</td>
                <td><span class="badge bg-label-success me-1">Tertunda</span></td>
            ...
            <tr>
                <td>5</td>
                <td><img src="{{ asset('assets/img/avatars/13.png') }}" alt="" style="width: 40px; border-radius:50%;"> Rafi</td>
                <td>21-03-2023</td>
                <td>Selasa</td>
                <td>Solo Project</td>
                <td><span class="badge bg-label-success me-1">Tertunda</span></td>
