                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="filter col-lg-3 col-md-3 col-sm-3">
                                ...
                                <form id="filterForm" action="{{ route('projek') }}" method="get">
                                    <select id="select2Basic" name="status_tim" class="form-select select2"
                                        data-allow-clear="true" onchange="filterProjek(this)">
                                        <option value="" disabled selected>Pilih Data</option>
                                        <option value="all" {{ request('status_tim') == 'all' ? 'selected' : '' }}>Semua
                                        </option>
                                        <option value="solo" {{ request('status_tim') == 'solo' ? 'selected' : '' }}>Solo
                                            Project
                                        </option>
                                        <option value="pre_mini"
                                            {{ request('status_tim') == 'pre_mini' ? 'selected' : '' }}>
                                            Pre-mini
                                            Project</option>
                                        <option value="mini" {{ request('status_tim') == 'mini' ? 'selected' : '' }}>Mini
                                            Project
                                        </option>
                                        <option value="big" {{ request('status_tim') == 'big' ? 'selected' : '' }}>Big
                                            Project
                                        </option>
                                    </select>
                            ...
                            <div class="card-body">
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center">
                                            <div class="d-flex flex-column align-items-end">
                                                ...
                                                @endif
                                                <span
                                                    class="badge bg-label-primary text-capitalize mt-1">{{ $item->tim->divisi->name }}</span>
                                            </div>
                                        </div>
                                ...
                                <div id="info" class="my-4">
                                    ...
                                    <div class="d-flex justify-content-between mt-3">
                                        <span>Status :</span>
                                        <div>
                                            @if ($item->status_keberhasilan == 'tidak_selesai' && $item->tim->kadaluwarsa == 1)
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a data-bs-target="#statusModal" data-bs-toggle="modal"
                                        ...
                                        data-namaTimStatus="{{ $item->tim->nama }}"
                                        class="w-100 btn btn-primary btn-status-tims"><span
                    ...
                    <div class="deskripsi">
                        <div class="penjelasan-1 card d-flex align-items-center justify-content-center mb-2 p-3">
                            <p class="mb-0">Status digunakan untuk memberikan tanda bahwa projectnya sudah <span
                                    class="fw-medium">Selesai</span> / <span class="fw-medium">Tidak Selesai</span> dan
                                tim tersebut
                                otomatis akan <span class="fw-medium">Expired</span></p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <form class="row g-3" id="updateStatus">
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                <select id="status_keb" name="status_keberhasilan" class="form-control w-100">
                                    <option id="selected" disabled selected>Pilih Status</option>
                                    <option id="selesai-value" value="selesai">Selesai</option>
                                    <option id="belum-value" value="tidak_selesai">Tidak Selesai</option>
                                </select>
                            </div>
