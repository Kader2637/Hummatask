                ...
                <div class="nav nav-tabs d-flex justify-content-between my-4" role="tablist">
                    <div class="card w-100">
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="nav-item w-25" role="presentation">
                                <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                    data-bs-target="#navs-pills-catatan" aria-controls="navs-pills-catatan"
                                    aria-selected="false" tabindex="-1">Catatan</button>
                            </div>
                            <div class="nav-item w-25" role="presentation">
                                <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                    data-bs-target="#navs-pills-board" aria-controls="navs-pills-board"
                                    aria-selected="false" tabindex="-1">Board</button>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div
                                                class="col-lg-5 align-items-center justify-content-center d-flex flex-column">
                                                <div>
                                                    <div class="text-center">
                                                        <img id="logo-tim"
                                                            src="{{ asset('storage/' . $project->tim->logo) }}"
                                                            alt='logo tim' class="rounded-circle mb-3"
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            <span class="badge bg-label-warning"
                                                                id="tema">{{ $project->tema->nama_tema }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="progres-bar">
                                                        ...
                                                        <div class="d-flex flex-grow-1 align-items-center my-1">
                                                            <div class="progress w-100 me-3"
                                                                ...
                                                                <div class="progress-bar bg-primary" role="progressbar"
                                                                    ...
                                                                    aria-valuenow="{{ $day['progresspercent'] }}"
                                                    ...
                                                    @else
                                                        <div class="alert alert-danger d-flex align-items-center"
                                                            ...
                                                            Project ini telah lewat deadline selama {{ $day['dayleft'] }}
                                                            hari, silahkan ke halaman project untuk perpanjang tenggat!
                                                        </div>
                                                    @endif
                                                </div>
                                                <div class="link mt-2">
                                                    ...
                                                    <a href="{{ $project->tim->repository }}" id="repository"
                            ...
                            <div class="row">
                                <div class="card cursor-default col-12 d-flex align-items-center justify-content-center">
                                    <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                        <img src="{{ asset('storage/' . $project->tim->logo) }}"
                                ...
                                <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                    ...
                                    @if ($catatan)
                                        @foreach ($catatan as $index => $catatanItem)
                                            <button
                                                class="nav-link text-truncate d-inline-block mb-2 {{ $loop->index == 0 ? 'active' : '' }}"
                                                style="max-width: 150px" id="v-pills-{{ $catatanItem->id }}-tab"
                                                data-bs-toggle="pill" data-bs-target="#v-pills-{{ $catatanItem->id }}"
                                ...
                                <div class="tab-content w-100" id="v-pills-tabContent">
                                    @forelse ($catatan as $index => $catatanTab)
                                        <div class="tab-pane fade {{ $loop->index == 0 ? 'show active' : '' }}"
                                            ...
                                            <div class="w-100">
                                                <form action="{{ route('mentor.update.catatan', $catatanTab->id) }}"
                                                    method="POST">
                                                    @method('PUT')
                                                    @csrf
                                                    <div
                                                        class="form-repeater d-flex flex-column justify-content-center align-items-center">
                                                        <input type="hidden" name="tim_id"
                                                            value="{{ $catatanTab->tim_id }}">
                                                        @forelse ($catatanTab->catatanDetail as $i => $data)
                                                            ...
                                                            <div class="form-add row mb-3 w-100">
                                                                <div
                                                                    class="col-11 col-md-{{ $hideDeleteButton ? '12' : '11' }}">
                        ...
                        <div style="height: 80vh" class="container-fluid mt-2">
                            @if (
                                $board['boardTugasBaru']->isNotEmpty() ||
                                    $board['boardRevisi']->isNotEmpty() ||
                                    $board['boardDikerjakan']->isNotEmpty() ||
                                    $board['boardSelesai']->isNotEmpty())
                                            ...
                                            @forelse ($board['boardTugasBaru'] as $item)
                                                <div class="col-12 d-flex justify-content-center">
                                                    <div class="row d-flex flex-column justify-content-center align-items-center w-100"
                                                        id="tugas_baru">
                                                        <div id="board-{{ $item->code }}" class="col-12 p-2 mt-3 card"
                                                            style="width: 100%;">
                                                            <div>
                                                                <div
