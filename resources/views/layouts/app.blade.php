                        ...
                        <ul class="">
                            ...
                            <li class="menu-item ">
                                <a href="{{ route('tim.board',$tim->uuid) }}" class="menu-link d-flex align-items-center gap-2">
                                    <img style="width: 30px;height:30px;object-fit: cover" class="rounded-circle border border-primary"
